    ...
    return (
        <div className="w-[500px] bg-[#262626] p-4 rounded-lg mb-4">
            <div className="flex items-center gap-5">
                <button className="bg-[#f6b100] p-3 text-xl font-bold text-white rounded-lg">
                    AM
                </button>
                <div className="flex items-center justify-between w-[100%]">
                    <div className="flex flex-col items-start gap-1">
                        <h1 className="text-white text-lg font-semibold tracking-wide">Lester Raguindin</h1>
            ...
            <div className="flex justify-between items-center mt-4 text-[#ababab]">
                <p> January 06, 2026 08:30 AM </p>
                <p> 8 Items </p>
            </div>
            <hr className="w-full mt-4 border-t-1 border-gray-500" />
            <div className="flex items-center justify-between mt-4">
                <h1 className="text-white text-lg font-semibold">Total</h1>
                <p className="text-white text-lg font-semibold"> ₱1500.00 </p>
            </div>
        </div>
    )
}
